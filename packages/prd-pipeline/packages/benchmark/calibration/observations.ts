...
// Dropped-claims queue, audit log, and control-arm seam have been extracted to
// calibration-seams.ts to keep this file under the 500-line limit (§4.1).
// Re-export them here for backward compatibility with importers of this module.
export {
  DROPPED_CLAIMS_PATH,
